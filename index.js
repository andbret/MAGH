...
var images = ['MAGH_PHOTOS/009.jpeg', 'MAGH_PHOTOS/030.jpeg','MAGH_PHOTOS/020.jpeg','MAGH_PHOTOS/032.jpeg'];
...
setInterval(function() {
   $top.animate({ fadeIn: 0 }, 2000, function() {
     $top.css('background-image', 'linear-gradient(to bottom, rgba(0, 0, 0, 0.0), rgba(0, 0, 0, 1.0)), url('+images[++index]+')');
